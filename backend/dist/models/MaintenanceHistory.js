...
const MaintenanceHistorySchema = new mongoose_1.Schema({
    maintenanceId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Maintenance', required: true },
...
exports.default = mongoose_1.default.model('MaintenanceHistory', MaintenanceHistorySchema);
