    ...
    <div className="w-full max-w-[420px] p-8 bg-white dark:bg-[#1F2937] rounded-xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-gray-800">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <button
          ...
          className="w-full h-12 mt-4 flex items-center justify-center rounded-lg text-sm font-semibold text-white bg-[#1976F3] dark:bg-[#3B82F6] hover:opacity-90 focus:outline-none disabled:opacity-50 transition-opacity"
        >
      ...
      <p className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
        ...
        <Link href="/login" className="font-medium text-[#1976F3] dark:text-[#3B82F6] hover:opacity-80">
          Login
        </Link>
      </p>
    </div>
